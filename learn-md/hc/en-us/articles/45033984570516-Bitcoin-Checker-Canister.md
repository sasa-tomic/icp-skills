...
![](/hc/article_attachments/45033948399764)
...
1. It uses an [HTTPS outcall](/hc/en-us/articles/34211194553492) to obtain the (binary) transaction that corresponds to the given transaction ID.
